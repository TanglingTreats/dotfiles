#!/bin/bash
clear
if [ -f ~/.config/desktop-config/settings/terminal.sh ]; then
    terminal="$(cat ~/.config/desktop-config/settings/terminal.sh)"
    ...
    echo "ERROR: ~/.config/desktop-config/settings/terminal.sh not found"
fi
sleep 3
