...
# Screenshot Filename
source ~/.config/desktop-config/settings/screenshot-filename.sh

# Screenshot Folder
source ~/.config/desktop-config/settings/screenshot-folder.sh

# Screenshot Editor
export GRIMBLAST_EDITOR="$(cat ~/.config/desktop-config/settings/screenshot-editor.sh)"
